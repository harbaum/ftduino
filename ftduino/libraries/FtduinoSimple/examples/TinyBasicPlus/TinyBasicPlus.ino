...
static const unsigned char initmsg[]          PROGMEM = "TinyBasic Plus " kVersion " for ftDuino";
...
#ifdef FTDUINO
  case KW_OUTPUT:  // OUTPUT <port>, <value>
    goto output;
  case KW_MOTOR:   // MOTOR <port>, <value>
    goto motor;
#endif
...
output:
  {
    ...
    ftduino.output_set(Ftduino::O1-1+inputNo, mode);
#endif
...
motor:
  {
    ...
    ftduino.motor_set(Ftduino::M1-1+inputNo, dir);
#endif
    goto run_next_statement;
  }
#endif /* FTDUINO */
