...
/*
 * This sketch works with the CJMCU 750 I²C uart adapter as show in
 * http://ftduino.de/manual/experimente.html#6.19.1
 */
...
SC16IS750 btSerial = SC16IS750(SC16IS750_PROTOCOL_I2C,SC16IS750_ADDRESS_BB);
